...
```
$ docker image tag blog gcr.io/wise-coyote-827/blog
$ docker push gcr.io/wise-coyote-827/blog
$ docker image tag gateway gcr.io/wise-coyote-827/gateway
$ docker push gcr.io/wise-coyote-827/gateway
$ docker image tag store gcr.io/wise-coyote-827/store
$ docker push gcr.io/wise-coyote-827/store
```
